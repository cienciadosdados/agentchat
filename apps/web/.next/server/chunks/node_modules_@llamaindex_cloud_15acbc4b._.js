...
"[project]/node_modules/@llamaindex/cloud/api/dist/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@llamaindex/cloud/reader/dist/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class LlamaParseReader extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$core$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileReader"] {
    #client;
    constructor(params = {}){
        ...
        const apiKey = params.apiKey ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$env$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEnv"])("LLAMA_CLOUD_API_KEY");
        if (!apiKey) {
        ...
        if (params.gpt4oMode) {
            params.gpt4oApiKey = params.gpt4oApiKey ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$env$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEnv"])("LLAMA_CLOUD_GPT4O_API_KEY");
            this.gpt4oApiKey = params.gpt4oApiKey;
        }
        if (params.useVendorMultimodalModel) {
            params.vendorMultimodalApiKey = params.vendorMultimodalApiKey ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$env$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEnv"])("LLAMA_CLOUD_VENDOR_MULTIMODAL_API_KEY");
    ...
    async #createJob(data, filename) {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uploadFileApiV1ParsingUploadPost"])({
            client: this.#client,
            throwOnError: true,
            query: {
    ...
    async getJobResult(jobId, resultType) {
        ...
        while(true){
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJobApiV1ParsingJobJobIdGet"])({
                client: this.#client,
                throwOnError: true,
                path: {
                    job_id: jobId
            ...
            if (status === "SUCCESS") {
                ...
                switch(resultType){
                    case "json":
                        {
                            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJobJsonResultApiV1ParsingJobJobIdResultJsonGet"])({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
                    ...
                    case "markdown":
                        {
                            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJobResultApiV1ParsingJobJobIdResultMarkdownGet"])({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
                    ...
                    case "text":
                        {
                            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJobTextResultApiV1ParsingJobJobIdResultTextGet"])({
                                client: this.#client,
                                throwOnError: true,
                                path: {
                                    job_id: jobId
   ...
   */ async loadDataAsContent(fileContent, filename) {
        return this.#createJob(fileContent, filename).then(async (jobId)=>{
            ...
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$core$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Document"]({
                    text: resultText
                })
            ];
        }).catch((error)=>{
   ...
   */ async getImages(jsonResult, downloadPath) {
    ...
    async fetchAndSaveImage(imageName, imagePath, jobId) {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$cloud$2f$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJobImageResultApiV1ParsingJobJobIdResultImageNameGet"])({
            client: this.#client,
            path: {
                job_id: jobId,
                name: imageName
    ...
    splitTextBySeparator(text) {
        ...
        return textChunks.map((docChunk)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$llamaindex$2f$core$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Document"]({
                text: docChunk
            }));
    }
}
...
//# sourceMappingURL=node_modules_%40llamaindex_cloud_15acbc4b._.js.map