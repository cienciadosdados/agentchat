...
"[project]/node_modules/@upstash/workflow/chunk-XVNSBBDC.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$CGY7C7LV$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@upstash/qstash/chunk-CGY7C7LV.mjs [app-route] (ecmascript)");
// src/agents/index.ts
...
;
var WorkflowError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QstashError"] {
    constructor(message){
        super(message);
...
var getSteps = async (requester, workflowRunId, messageId, debug)=>{
    try {
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QstashError"] && error.status === 404) {
...
;
var triggerFirstInvocation = async ({ workflowContext, useJSONContent, telemetry, debug, invokeCount, delay })=>{
...
var triggerRouteFunction = async ({ onCleanup, onStep, onCancel, debug })=>{
    try {
        ...
        const error_ = error;
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QstashError"] && error.status === 400) {
...
var handleThirdPartyCallResult = async ({ request, requestPayload, client, workflowUrl, failureUrl, retries, telemetry, flowControl, debug })=>{
    try {
...
var LazyInvokeStep = class extends BaseLazyStep {
   ...
   */ workflowId;
    constructor(stepName, { workflow, body, headers = {}, workflowRunId, retries, flowControl }){
        super(stepName);
        this.params = {
            workflow,
            body,
   ...
   */ getResultStep(concurrent, stepId) {
    ...
    getHeaders({ context, telemetry, invokeCount }) {
        const { workflow, headers = {}, workflowRunId = getWorkflowRunId(), retries, flowControl } = this.params;
        const newUrl = context.url.replace(/[^/]+$/, this.workflowId);
        const { retries: workflowRetries, failureFunction, failureUrl, useJSONContent, flowControl: workflowFlowControl } = workflow.options;
...
var prepareFlowControl = (flowControl)=>{
    ...
    if (controlValue.length === 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QstashError"]("Provide at least one of parallelism or ratePerSecond for flowControl");
    }
    return {
            ...
            case "partial":
                {
                    ...
                    try {
                        ...
                        if (error instanceof WorkflowAbort || error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QstashError"] && error.status === 400) {
                            throw error;
                        }
...
var AnthropicAPI = class extends BaseWorkflowApi {
    async call(stepName, settings) {
        ...
        return await this.callApi(stepName, {
            api: {
                name: "llm",
                provider: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["anthropic"])({
                    token
                })
            },
            ...parameters
...
var OpenAIAPI = class extends BaseWorkflowApi {
    async call(stepName, settings) {
        ...
        const provider = useOpenAI ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["openai"])({
            token,
            organization
        }) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["custom"])({
            baseUrl: baseURL,
            token
        });
        return await this.callApi(stepName, {
...
var ResendAPI = class extends BaseWorkflowApi {
    async call(stepName, settings) {
        ...
        return await this.callApi(stepName, {
            api: {
                name: "email",
                provider: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$CGY7C7LV$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resend"])({
                    token,
                    batch
                })
            },
...
var Agent = class {
   ...
   */ async call({ prompt }) {
        try {
            ...
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ToolExecutionError"]) {
                if (error.cause instanceof Error && error.cause.name === "WorkflowAbort") {
                    throw error.cause;
                } else if (error.cause instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ToolExecutionError"] && error.cause.cause instanceof Error && error.cause.cause.name === "WorkflowAbort") {
   ...
   */ asTool() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tool"])({
            parameters: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
                prompt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string()
            }),
...
var WorkflowAgents = class {
   ...
   */ openai(...params) {
        ...
        const openaiModel = this.AISDKModel({
            context: this.context,
            provider: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$openai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOpenAI"],
            providerParams: {
                baseURL,
                apiKey,
   ...
   */ async sleepUntil(stepName, datetime) {
    ...
    async call(stepName, settings) {
        ...
        if ("workflow" in settings) {
            ...
            callStep = new LazyCallStep(stepName, url, "POST", settings.body, settings.headers || {}, settings.retries || 0, settings.timeout, settings.flowControl ?? settings.workflow.options.flowControl);
        } else {
            const { url, method = "GET", body, headers = {}, retries = 0, timeout, flowControl } = settings;
            callStep = new LazyCallStep(stepName, url, method, body, headers, retries, timeout, flowControl);
        }
...
var DisabledWorkflowContext = class _DisabledWorkflowContext extends WorkflowContext {
   ...
   */ static async tryAuthentication(routeFunction, context) {
        const disabledContext = new _DisabledWorkflowContext({
            qstashClient: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Client"]({
...
var processOptions = (options)=>{
    ...
    return {
        ...
        receiver: receiverEnvironmentVariablesSet ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Receiver"]({
...
var serveBase = (routeFunction, telemetry, options)=>{
    const { qstashClient, onStepFinish, initialPayloadParser, url, verbose, receiver, failureUrl, failureFunction, baseUrl, env, retries, useJSONContent, disableTelemetry, flowControl, onError } = processOptions(options);
    ...
    const handler = async (request)=>{
        ...
        const failureCheck = await handleFailure(request, requestPayload, qstashClient, initialPayloadParser, routeFunction, failureFunction, env, retries, flowControl, debug);
...
"[project]/node_modules/@upstash/workflow/index.mjs [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@upstash/workflow/chunk-XVNSBBDC.mjs [app-route] (ecmascript)");
// src/client/index.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@upstash/qstash/index.mjs [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@upstash/qstash/chunk-SSGARCU5.mjs [app-route] (ecmascript)");
;
...
var Client = class {
    ...
    constructor(clientConfig){
        ...
        this.client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$SSGARCU5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Client"](clientConfig);
    }
    /**
   ...
   */ async notify({ eventId, eventData }) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeNotifyRequest"])(this.client.http, eventId, eventData);
    }
    /**
   ...
   */ async getWaiters({ eventId }) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeGetWaitersRequest"])(this.client.http, eventId);
    }
    /**
   ...
   */ async trigger({ url, body, headers, workflowRunId, retries, flowControl, delay }) {
        const finalWorkflowRunId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkflowRunId"])(workflowRunId);
        const context = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WorkflowContext"]({
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$upstash$2f$workflow$2f$chunk$2d$XVNSBBDC$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["triggerFirstInvocation"])({
...
"[project]/node_modules/@upstash/workflow/index.mjs [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40upstash_workflow_8a915742._.js.map